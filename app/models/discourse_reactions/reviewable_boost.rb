...
module DiscourseReactions
  class ReviewableBoost < Reviewable
    ...
    def serializer
      DiscourseReactions::BoostSerializer
    end
    ...
    def boost
      @boost ||= (target || DiscourseReactions::Boost.with_deleted.find_by(id: target_id))
    end
    ...
    def perform_agree_and_delete(performed_by, args)
      agree { boost.trash!(performed_by) }
    end

    def perform_disagree_and_restore(performed_by, args)
      disagree { boost.recover! }
    end
    ...
    def perform_delete_and_ignore(performed_by, args)
      ignore { boost.trash!(performed_by) }
    end
    ...
    def disagree
      ...
      UserSilencer.unsilence(boost_creator)
    ...
    def build_action(
      ...
      actions.add(id, bundle: bundle) do |action|
        ...
        action.label = "boost.#{prefix}.title"
        action.description = "boost.#{prefix}.description"
